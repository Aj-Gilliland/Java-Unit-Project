...
//    }
    ...
    private static void displayPasswords(List<Password> passwords){
            ...
            //Password(id, title, ivspec, key, image, person_id)

            passwords.forEach(element -> {
                try {
                    System.out.println(element.id + ". " + element.title + "\n" + decrypt(element.ivspec, decodeImage(element.image), element.key));
